...
module.exports = function(app) {
    ...
    app.get(`/api/${apiPath}/:pSlug`, controller.findOne); //--get all
    app.post(`/api/product/create`, sysUpload.upload.array("images",10), [authJwt.verifyToken, authJwt.isAdmin], controller.create); //--create new
